...
function setButtonsToolTip() {
    ...
    // main buttons
    setTippy(shareRoomBtn, 'Invitar a otros a unirse', 'right-start');
    setTippy(audioBtn, 'Stop audio', 'right-start');
    setTippy(videoBtn, 'Stop video', 'right-start');
...
function initClientPeer() {
    ...
    // document.getElementsByClassName("fadein").style.display = "none" 
...
async function whoAreYou() {
    ...
    if (myPeerName) {
        console.log('13. checkPeerAudioVideo');
    ...
    Swal.fire({
        ...
        inputValidator: (value) => {
            if (!value) return 'por favor, escriba su nombre';
            myPeerName = value;
...
async function initEnumerateDevices() {
    ...
    //         position: 'center',
    //         imageUrl: camMicOff,
    //         title: 'Cámara y micrófono no permitidos',
    //         text: "Meet necesita acceso a la cámara y al micrófono. "+
    //               "Haga clic en el icono de cámara y micrófono bloqueados en la barra de direcciones de su navegador antes de unirse a la sala.",
    //         showDenyButton: false,
    //         confirmButtonText: `OK`,
    //         showClass: {
    //             popup: 'animate__animated animate__fadeInDown',
